...
import ImageOne from "../../public/detailing_five.jpg";
import ImageTwo from "../../public/detailing_three.jpg";

export const SignatureDetailing = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {translations.detailingCarCarePackage.map((detailing, index) => {
          return (
            <Text
